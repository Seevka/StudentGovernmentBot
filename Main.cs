        ...
        ReplyKeyboardMarkup startKeyboard = new(new[]
{
        ...
        public override async Task OnPrivateChat(Chat chat, User user, UpdateInfo update)
        {
            ...
            {
                await Telegram.SendTextMessageAsync(chat, "Актуальна інформація щодо розкладу та анонсів Днів відкритих дверей у Львівському національному університету імені Івана Франка розміщується на сторінках для вступників у соціальних мережах: [Інстаграм](https://instagram.com/lnuvstup?igshid=MzRlODBiNWFlZA==)\r\n\r\n[Телеграм](https://t.me/entrantlnu)", disableWebPagePreview: true, parseMode: ParseMode.Markdown);
                return;
            }
