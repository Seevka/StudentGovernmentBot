...
{
                new KeyboardButton[] { "Контакти Приймальної комісії📲", "Дізнатись більше про навчання на факультеті 😎"},
                new KeyboardButton[] { "Дні відкритих дверей⏰","Студентські ради у соціальних мережах💻"},
