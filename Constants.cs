...
namespace StudentGovernment
{
    ...
    class Master : MainClass
    {
        private Dictionary<string, string> MasterAnswers = new Dictionary<string, string>()
        {
            ...
            {"Подання заяв на вступ до магістратури✅", "\U0001f9d1‍🎓Подання заяв для здобуття освітнього ступеня «Магістр» відбуватиметься до 18:00 21 серпня\r\n\r\n😉Подання відбувається з електронного кабінету вступника. (https://cabinet.edbo.gov.ua/login) \r\n\r\n📃Із вимогами до написання мотиваційного листа можна ознайомитися за посиланням. (https://admission.lnu.edu.ua/wp-content/uploads/2023/04/Dodatok_11.pdf) \r\n\r\nЗауважимо, що вступник може подати лише до п’яти заяв на бюджетну форму 📌\r\n\r\nПри подачі заяв зазначаєте пріоритетність: 1 - куди хочете найбільше, 5 - відповідно найменше. \r\n\r\n‼️Аби вберегти вас від найпоширенішої помилки при поданні заяв, наголошуємо:\r\n\r\nПункт «Обраний освітній ступінь (рівень) за бюджетні кошти» стосується саме освітнього рівня магістра. Тобто, якщо ви навчались на бюджеті на бакалавраті, але не навчались на бюджеті на магістратурі — обираєте «ніколи не здобувався». \r\n\r\n\U0001f9d1‍🎓Уся актуальна інформація щодо вступу в магістратуру є на сайті (https://admission.lnu.edu.ua/) Вступної кампанї ЛНУ ім. Івана Франка. \r\n\r\n❓Якщо у вас виникають запитання щодо процесу подання заяв — звертайтесь у деканат вашого факультету." },
...
{               new KeyboardButton[] { "Детальніше про вступ в магістратуру🧑‍🎓", "Порядок розгляду та вимоги до написання мотиваційного листа✍️"},
                ...
                new KeyboardButton[] { "Подання заяв на вступ до магістратури✅"},
                new KeyboardButton[] { "Вернутися на початок"},
})
        {
            ResizeKeyboard = true
