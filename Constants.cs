        ...
        public ReplyKeyboardMarkup AdminKeyboard => new(new[]
{
    ...
    class AMI : Faculty
    {
        private static Dictionary<string, string> AmiAnswers = new Dictionary<string, string>()
        {
            ...
            {"Задати питання адміністратру ФПМІ", "Напиши своє питання нижче та натисни готово, а ми обов'язково зв'яжемося з тобою!" },
        };
        ...
        public override ReplyKeyboardMarkup ReplyKeyboardMarkup => new(new[]
{
                ...
                new KeyboardButton[] { "Задати питання адміністратру ФПМІ", "Вернутися на початок 👨‍💻"},
                new KeyboardButton[] { "Адміністрування"},
})
        {
            ResizeKeyboard = true
    ...
    class CultArt : Faculty
    {
        private Dictionary<string, string> CultArtAnswers = new Dictionary<string, string>()
        {
            ...
            {"Вернутися на початок 🎨", "Натисни сюди: /restart" },
            {"Зaдати питання адміністратуру ФКІМ", "Напиши своє питання нижче та натисни готово, а ми обов'язково зв'яжемося з тобою!" },
        ...
        public override ReplyKeyboardMarkup ReplyKeyboardMarkup => new(new[]
{
                ...
                new KeyboardButton[] { "Зaдати питання адміністратуру ФКІМ", "Вернутися на початок 🎨" },
})
        {
            ResizeKeyboard = true
        };
