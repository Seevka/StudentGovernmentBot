...
namespace StudentGovernment
{
    ...
    class Bachelor : MainClass
    {
        ...
        public override ReplyKeyboardMarkup ReplyKeyboardMarkup => new(new[] {
                ...
                new KeyboardButton[] { "Вартість навчання💶", "Творчі конкурси та терміни реєстрації🎭"},
    ...
    class Master : MainClass
    {
        ...
        {
            {"Програми фахових випробувань📃", "Програми вступних випробувань для здобуття ОС «Магістри» у Льввівському національному університеті імені Івана Франка на 2023 рік можете переглянути за посиланням: \r\n\r\nhttps://admission.lnu.edu.ua/for-undergraduate-students/programs-of-entrance-examinations/"},
